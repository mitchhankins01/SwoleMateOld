...
export default async (event: FunctionEvent<EventData>) => {
  ...
  try {
    ...
    const { email, password, name, theme, imperial } = event.data;
...
async function createGraphcoolUser(
  ...
  const mutation = `
    mutation createGraphcoolUser($email: String!, $password: String!, $name: String!, $theme: String!, $imperial: Boolean!) {
      createUser(
        email: $email,
        password: $password,
        name: $name,
